    ...
    public partial class PhoneNumberEditableTemplate : BasicUserControl
    {
        ...
        private void Confirm_Click(object sender, RoutedEventArgs e)
        {
            if (DataContext is UserPhone phone)
            {
                ...
                { 
                    this.ConfirmWindow.Show($"Czy jesteś pewien że chcesz zmienić numer telefonu {phoneNumberBeforeEdited.ToString()} na {this.EditNote.Text} - {this.EditPhoneNumber.Text}?",
        ...
        #endregion
        #region EditPhoneNumber_TextChanged
        /// <summary>
        /// User can write only numbers.
        /// </summary>
        /// <param name="sender">TextBox</param>
        /// <param name="e">New char in text field event</param>
        private void EditPhoneNumber_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
            char[] charArray;
